...
function ddwc_driver_dashboard_change_status_forms() {
	...
	if ( 'driver-assigned' == $order_status ) {
		$change_status  = '<h4>' . esc_attr__( 'Update Delivery Status', 'ddwc' ) . '</h4>';
		$change_status .= '<form method="post">';
		$change_status .= '<p><strong>' . esc_attr__( 'Shipping note here.', 'ddwc' ) . '</strong></p>';
		$change_status .= '<input type="text" name="outfordeliverymessage" value="" placeholder="' . esc_attr__( 'Add a note', 'ddwc' ) . '" class="ddwc-ofdmsg" required/>';
		$change_status .= '<input type="hidden" name="outfordelivery" value="out-for-delivery" />';
		$change_status .= '<input type="submit" value="' . esc_attr__( 'Delivery Picked Up', 'ddwc' ) . '" class="button ddwc-change-status" />';
	...
	if ( 'out-for-delivery' == $order_status ) {
		...
		$change_status .= '<p><strong>' . esc_attr__( 'Shipping note here.', 'ddwc' ) . '</strong></p>';
		$change_status .= '<input type="text" name="ordermessage" value="" placeholder="' . esc_attr__( 'Add a note', 'ddwc' ) . '" class="ddwc-ofdmsg" />';
		...
		$change_status .= '<input type="submit" name="ordercompleted" id="ordercompleted" value="' . esc_attr__( 'Complete', 'ddwc' ) . '" class="button ddwc-change-status" />';
