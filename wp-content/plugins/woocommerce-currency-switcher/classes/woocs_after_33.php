...
//auto swither
            ...
            $geoIP_profiles = array('woocs_profile_def_hjgft671' => array(
                    'name' => __('EU countries', 'woocommerce-currency-switcher'),
...
//***
    ...
    public function plugin_action_links($links) {
        ...
        if ($this->notes_for_free) {
            $buttons[] = '<a target="_blank" style="color: red; font-weight: bold;" href="' . esc_url('https://codecanyon.pluginus.net/item/woocommerce-currency-switcher/8085217') . '">' . esc_html__('Go Pro!', 'woocommerce-currency-switcher') . '</a>';
        }
