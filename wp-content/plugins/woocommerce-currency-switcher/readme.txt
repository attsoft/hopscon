...
WooCommerce Currency Switcher is multi currency plugin for woocommerce that allows to switch products prices and get their rates converted in the real time!
...
5. Tab Side switcher options
6. Tab Payment rules
7. Tab GeoLocation IP rules
8. Tab Statistic
9. Price based on user roles
10. Fixed minimum amount for shipping for each currency
11. Fixed prices for FREE delivery for each currency
12. Fixed amount for coupons for each currency
